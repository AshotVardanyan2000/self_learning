...
const drawWinner = (gameBoard, players) => {
  let winner = null;
...
function App() {
  ...
  const winner = drawWinner(gameBoard, playerName);
      ...
      const updatePrev = [
        {
          ...
          player: deriveActivePlayers(prev),
        },
        ...prev,
      ];
  ...
  const handleEditPlayersName = (symbol, newName) => {
      ...
      <div id="game-container">
        <ol id="players" className="highlight-player">
          <Players
            ...
            onChangeName={handleEditPlayersName}
          />
          <Players
